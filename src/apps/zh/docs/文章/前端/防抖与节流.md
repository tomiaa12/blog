...
<<< @/apps/zh/docs/文章/前端/components/debounce.ts
...
<<< @/apps/zh/docs/文章/前端/components/debounce.vue
:::
...
<<< @/apps/zh/docs/文章/前端/components/throttle.ts
...
```js
const ctx = throttle(function (str) {
  return str + " world"
}, 0)
...
::: details 点击查看 Demo 代码
<<< @/apps/zh/docs/文章/前端/components/throttle.vue
:::
