...
import transient from './j.mp3'
import dancing from './jntm.mp3'
import crazy from './ngm.mp3'
...
class IKun {
  ...
  draw = () => {
    ...
    const ny =
      sin * x + cos * (150 + y) + this.height / 2 + this.imageHeight / 2 - 150
